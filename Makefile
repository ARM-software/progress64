...
OBJECTS_libprogress64.a = p64_ringbuf.o p64_spinlock.o p64_rwlock.o p64_barrier.o p64_hazardptr.o p64_hashtable.o p64_timer.o p64_rwsync.o p64_antireplay.o p64_reorder.o p64_reassemble.o p64_laxrob.o p64_clhlock.o p64_rwsync_r.o p64_rwlock_r.o os_abstraction.o thr_idx.o p64_qsbr.o p64_tfrwlock.o p64_tfrwlock_r.o p64_tktlock.o p64_pfrwlock.o p64_semaphore.o p64_rwclhlock.o p64_stack.o p64_msqueue.o p64_counter.o p64_errhnd.o p64_mbtrie.o p64_hopscotch.o p64_buckrob.o p64_buckring.o p64_cuckooht.o p64_skiplock.o p64_mcslock.o p64_mcas.o p64_hemlock.o p64_coroutine.o p64_fiber.o p64_lfstack.o p64_blkring.o ver_lfstack.o ver_msqueue.o ver_clhlock.o ver_mcslock.o ver_blkring.o ver_hemlock.o ver_barrier.o ver_buckring1.o ver_buckring2.o ver_cuckooht1.o ver_cuckooht2.o ver_ringbuf.o ver_hopscotch1.o ver_spinlock.o
