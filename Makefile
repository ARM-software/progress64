...
TARGETS = libprogress64.a hashtable timer rwlock reorder antireplay rwsync rwsync_r reassemble laxrob ringbuf clhlock lfring bm_ringbuf
#List object files for each target
OBJECTS_libprogress64.a = p64_ringbuf.o p64_spinlock.o p64_rwlock.o p64_barrier.o p64_hazardptr.o p64_hashtable.o p64_timer.o p64_rwsync.o p64_antireplay.o p64_reorder.o p64_reassemble.o p64_laxrob.o p64_clhlock.o p64_lfring.o p64_rwsync_r.o
...
OBJECTS_rwsync_r = p64_rwsync.o p64_rwsync_r.o rwsync_r.o
