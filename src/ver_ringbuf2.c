...
static void
ver_ringbuf2_init(uint32_t numthreads)
{
...
static void
ver_ringbuf2_fini(uint32_t numthreads)
{
    (void)numthreads;
...
struct ver_funcs ver_ringbuf2 =
{
    "ringbuf2", ver_ringbuf2_init, ver_ringbuf2_exec, ver_ringbuf2_fini
};
